...
public class AddMessageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			dbUtilities.addMessagesToCoreNode(uname, uId, url, message);;	//need to be implemented with parameters
		}
		else
		{
			dbUtilities.addMessageToURLNode(uname, uId, url, message);;	//need to be implemented with parameters
		}
		pw.write("rcvd");
	}
